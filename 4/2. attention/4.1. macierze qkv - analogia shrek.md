...
1. Osioł szuka rośliny, macierz Q pozwala na zadawanie pytań o konkretne cechy z embedingów: rośliny, niebieskości kwiatu, kolczastość
2. Każdy obiekt w lesie (kamień, liść, róża, mikołajek) ma nałożony filtr macierzy K wyostrzająca z ich embedingów cech: rośliny, niebieskości kwiatu, kolczastość 
...
5. Osioł nakłada macierz V zabierając nektar; usuwa kolce, płatki, łodygi
